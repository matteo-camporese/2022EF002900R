...
subplot(2,2,2)
plot(TOTIRR,1000*86400*T,'LineWidth',1.0);
xlabel('Irradiance (W m^{-2})')
ylabel('T (mm d^{-1})')
% axis tight
ax = gca;
...
subplot(2,2,3)
plot(TOTIRR,1./rs,'LineWidth',1.0);
% plot(TOTIRR,rs,'LineWidth',1.0);
xlabel('Irradiance (W m^{-2})')
ylabel('g_s (m s^{-1})')
% ylabel('r_s (s m^{-1})')
% axis tight
